 ...
 * columns
 */
const columns = { action: _columns_action__WEBPACK_IMPORTED_MODULE_0__, type: _columns_type__WEBPACK_IMPORTED_MODULE_2__, style: _columns_style__WEBPACK_IMPORTED_MODULE_1__ };
...
/* harmony export */ });
/* harmony import */ var _internal_calc__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../internal/calc */ "./src/internal/calc.ts");
/* harmony import */ var _internal_hiDPI__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../internal/hiDPI */ "./src/internal/hiDPI.ts");
/* harmony import */ var _internal_style__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../internal/style */ "./src/internal/style.ts");
/* harmony import */ var _internal_utils__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../internal/utils */ "./src/internal/utils.ts");
/* harmony import */ var _DG_EVENT_TYPE__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./DG_EVENT_TYPE */ "./src/core/DG_EVENT_TYPE.ts");
/* harmony import */ var _internal_EventHandler__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../internal/EventHandler */ "./src/internal/EventHandler.ts");
/* harmony import */ var _EventTarget__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./EventTarget */ "./src/core/EventTarget.ts");
/* harmony import */ var _internal_NumberMap__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../internal/NumberMap */ "./src/internal/NumberMap.ts");
/* harmony import */ var _internal_Rect__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../internal/Rect */ "./src/internal/Rect.ts");
/* harmony import */ var _internal_Scrollable__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../internal/Scrollable */ "./src/internal/Scrollable.ts");
/* harmony import */ var _internal_canvases__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../internal/canvases */ "./src/internal/canvases.ts");
/* harmony import */ var _internal_symbolManager__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../internal/symbolManager */ "./src/internal/symbolManager.ts");
/* harmony import */ var _internal_paste_utils__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../internal/paste-utils */ "./src/internal/paste-utils.ts");
...
getKeyCode, 
/** @private */
cancel: cancelEvent } = _internal_utils__WEBPACK_IMPORTED_MODULE_3__.event;
/** @private */
const _ = (0,_internal_symbolManager__WEBPACK_IMPORTED_MODULE_11__.getProtectedSymbol)();
/** @private */
...
function _getTargetRowAt(absoluteY) {
    ...
    // return internal
    // }
    if ((0,_internal_utils__WEBPACK_IMPORTED_MODULE_3__.isDef)(internal)) {
        return internal;
    }
...
function _getFrozenRowsRect(grid) {
    ...
    return new _internal_Rect__WEBPACK_IMPORTED_MODULE_8__.Rect(grid[_].scroll.left, top, grid[_].canvas.width, height);
}
/** @private */
function _getFrozenColsRect(grid) {
    ...
    return new _internal_Rect__WEBPACK_IMPORTED_MODULE_8__.Rect(left, grid[_].scroll.top, width, grid[_].canvas.height);
}
/** @private */
...
function _drawCell(ctx, col, absoluteLeft, width, row, absoluteTop, height, visibleRect, skipAbsoluteTop, skipAbsoluteLeft, drawLayers) {
    const rect = new _internal_Rect__WEBPACK_IMPORTED_MODULE_8__.Rect(absoluteLeft - visibleRect.left, absoluteTop - visibleRect.top, width, height);
    const drawRect = _internal_Rect__WEBPACK_IMPORTED_MODULE_8__.Rect.bounds(Math.max(absoluteLeft, skipAbsoluteLeft) - visibleRect.left, Math.max(absoluteTop, skipAbsoluteTop) - visibleRect.top, rect.right, rect.bottom);
    if (drawRect.height > 0 && drawRect.width > 0) {
        ...
        try {
            ...
            if ((0,_internal_utils__WEBPACK_IMPORTED_MODULE_3__.isPromise)(p)) {
                //遅延描画
...
function _toPxWidth(grid, width) {
    return Math.round(_internal_calc__WEBPACK_IMPORTED_MODULE_0__.toPx(width, grid[_].calcWidthContext));
}
/** @private */
...
function _moveFocusCell(col, row, shiftKey) {
    ...
    if (afterRect.intersection(beforeRect)) {
        const invalidateRect = _internal_Rect__WEBPACK_IMPORTED_MODULE_8__.Rect.max(afterRect, beforeRect);
...
function _updatedSelection() {
    ...
    const results = this.fireListeners(_DG_EVENT_TYPE__WEBPACK_IMPORTED_MODULE_4__.DG_EVENT_TYPE.EDITABLEINPUT_CELL, {
        col: selCol,
        row: selRow
    });
    const editMode = _internal_utils__WEBPACK_IMPORTED_MODULE_3__.array.findIndex(results, (v) => !!v) >= 0;
    focusControl.editMode = editMode;
    if (editMode) {
        focusControl.storeInputStatus();
        focusControl.setDefaultInputStatus();
        this.fireListeners(_DG_EVENT_TYPE__WEBPACK_IMPORTED_MODULE_4__.DG_EVENT_TYPE.MODIFY_STATUS_EDITABLEINPUT_CELL, {
            col: selCol,
            row: selRow,
...
function _bindEvents() {
    ...
    handler.on(element, 'mousedown', (e) => {
        ...
        if (eventArgs) {
            const results = grid.fireListeners(_DG_EVENT_TYPE__WEBPACK_IMPORTED_MODULE_4__.DG_EVENT_TYPE.MOUSEDOWN_CELL, eventArgs);
            if (_internal_utils__WEBPACK_IMPORTED_MODULE_3__.array.findIndex(results, (v) => !v) >= 0) {
                return;
            }
        }
    ...
    handler.on(element, 'mouseup', (e) => {
        if (!grid.hasListeners(_DG_EVENT_TYPE__WEBPACK_IMPORTED_MODULE_4__.DG_EVENT_TYPE.MOUSEUP_CELL)) {
            return;
        }
        const { eventArgs } = getCellEventArgsSet(e);
        if (eventArgs) {
            grid.fireListeners(_DG_EVENT_TYPE__WEBPACK_IMPORTED_MODULE_4__.DG_EVENT_TYPE.MOUSEUP_CELL, eventArgs);
        }
    });
    ...
    handler.on(element, 'touchstart', (e) => {
        if (!doubleTapBefore) {
            ...
            if (eventArgs && eventArgs.col === doubleTapBefore.col && eventArgs.row === doubleTapBefore.row) {
                grid.fireListeners(_DG_EVENT_TYPE__WEBPACK_IMPORTED_MODULE_4__.DG_EVENT_TYPE.DBLTAP_CELL, eventArgs);
            }
            doubleTapBefore = null;
    ...
    function onMouseenterCell(cell, related) {
        grid.fireListeners(_DG_EVENT_TYPE__WEBPACK_IMPORTED_MODULE_4__.DG_EVENT_TYPE.MOUSEENTER_CELL, {
            col: cell.col,
            row: cell.row,
            related
        });
    ...
    function onMouseleaveCell(related) {
        ...
        mouseEnterCell = null;
        if (beforeMouseCell) {
            grid.fireListeners(_DG_EVENT_TYPE__WEBPACK_IMPORTED_MODULE_4__.DG_EVENT_TYPE.MOUSELEAVE_CELL, {
    ...
    function onMouseoverCell(cell, related) {
        grid.fireListeners(_DG_EVENT_TYPE__WEBPACK_IMPORTED_MODULE_4__.DG_EVENT_TYPE.MOUSEOVER_CELL, {
            col: cell.col,
            row: cell.row,
            related
        });
    ...
    function onMouseoutCell(related) {
        ...
        mouseOverCell = null;
        if (beforeMouseCell) {
            grid.fireListeners(_DG_EVENT_TYPE__WEBPACK_IMPORTED_MODULE_4__.DG_EVENT_TYPE.MOUSEOUT_CELL, {
                col: beforeMouseCell.col,
                row: beforeMouseCell.row,
                related
            });
    ...
    handler.on(element, 'mousemove', (e) => {
        ...
        if (eventArgs) {
            const beforeMouseCell = mouseEnterCell;
            if (beforeMouseCell) {
                grid.fireListeners(_DG_EVENT_TYPE__WEBPACK_IMPORTED_MODULE_4__.DG_EVENT_TYPE.MOUSEMOVE_CELL, eventArgs);
    ...
    handler.on(element, 'click', (e) => {
        ...
        if (!grid.hasListeners(_DG_EVENT_TYPE__WEBPACK_IMPORTED_MODULE_4__.DG_EVENT_TYPE.CLICK_CELL)) {
            return;
        }
        const { eventArgs } = getCellEventArgsSet(e);
        if (!eventArgs) {
        ...
        grid.fireListeners(_DG_EVENT_TYPE__WEBPACK_IMPORTED_MODULE_4__.DG_EVENT_TYPE.CLICK_CELL, eventArgs);
    });
    handler.on(element, 'contextmenu', (e) => {
        if (!grid.hasListeners(_DG_EVENT_TYPE__WEBPACK_IMPORTED_MODULE_4__.DG_EVENT_TYPE.CONTEXTMENU_CELL)) {
            return;
        }
        const { eventArgs } = getCellEventArgsSet(e);
        if (!eventArgs) {
        ...
        grid.fireListeners(_DG_EVENT_TYPE__WEBPACK_IMPORTED_MODULE_4__.DG_EVENT_TYPE.CONTEXTMENU_CELL, eventArgs);
    });
    handler.on(element, 'dblclick', (e) => {
        if (!grid.hasListeners(_DG_EVENT_TYPE__WEBPACK_IMPORTED_MODULE_4__.DG_EVENT_TYPE.DBLCLICK_CELL)) {
            return;
        }
        const { eventArgs } = getCellEventArgsSet(e);
        if (!eventArgs) {
        ...
        grid.fireListeners(_DG_EVENT_TYPE__WEBPACK_IMPORTED_MODULE_4__.DG_EVENT_TYPE.DBLCLICK_CELL, eventArgs);
    });
    grid[_].focusControl.onKeyDown((evt) => {
        grid.fireListeners(_DG_EVENT_TYPE__WEBPACK_IMPORTED_MODULE_4__.DG_EVENT_TYPE.KEYDOWN, evt);
    });
    grid[_].selection.listen(_DG_EVENT_TYPE__WEBPACK_IMPORTED_MODULE_4__.DG_EVENT_TYPE.SELECTED_CELL, (data) => {
        grid.fireListeners(_DG_EVENT_TYPE__WEBPACK_IMPORTED_MODULE_4__.DG_EVENT_TYPE.SELECTED_CELL, data, data.selected);
    });
    scrollable.onScroll((e) => {
        _onScroll(grid, e);
        grid.fireListeners(_DG_EVENT_TYPE__WEBPACK_IMPORTED_MODULE_4__.DG_EVENT_TYPE.SCROLL, { event: e });
    });
    ...
    grid[_].focusControl.onCopy((_e) => _internal_utils__WEBPACK_IMPORTED_MODULE_3__.array.find(grid.fireListeners('copydata', grid[_].selection.range), (r) => r != null));
    grid[_].focusControl.onPaste(({ value, event }) => {
        ...
        const pasteCellEvent = {
            ...
            multi,
            get rangeBoxValues() {
                return rangeBoxValues ?? (rangeBoxValues = (0,_internal_paste_utils__WEBPACK_IMPORTED_MODULE_12__.parsePasteRangeBoxValues)(normalizeValue));
            },
            event
        };
        grid.fireListeners(_DG_EVENT_TYPE__WEBPACK_IMPORTED_MODULE_4__.DG_EVENT_TYPE.PASTE_CELL, pasteCellEvent);
    });
    grid[_].focusControl.onInput((value) => {
        const { col, row } = grid[_].selection.select;
        grid.fireListeners(_DG_EVENT_TYPE__WEBPACK_IMPORTED_MODULE_4__.DG_EVENT_TYPE.INPUT_CELL, { col, row, value });
    });
    grid[_].focusControl.onDelete((event) => {
        const { col, row } = grid[_].selection.select;
        grid.fireListeners(_DG_EVENT_TYPE__WEBPACK_IMPORTED_MODULE_4__.DG_EVENT_TYPE.DELETE_CELL, { col, row, event });
    });
    grid[_].focusControl.onFocus((e) => {
        grid.fireListeners(_DG_EVENT_TYPE__WEBPACK_IMPORTED_MODULE_4__.DG_EVENT_TYPE.FOCUS_GRID, e);
        grid[_].focusedGrid = true;
        const { col, row } = grid[_].selection.select;
        grid.invalidateCell(col, row);
    });
    grid[_].focusControl.onBlur((e) => {
        grid.fireListeners(_DG_EVENT_TYPE__WEBPACK_IMPORTED_MODULE_4__.DG_EVENT_TYPE.BLUR_GRID, e);
...
function _getVisibleRect(grid) {
    ...
    return new _internal_Rect__WEBPACK_IMPORTED_MODULE_8__.Rect(left, top, width, height);
}
/** @private */
function _getScrollableVisibleRect(grid) {
    ...
    return new _internal_Rect__WEBPACK_IMPORTED_MODULE_8__.Rect(grid[_].scrollable.scrollLeft + frozenColsWidth, grid[_].scrollable.scrollTop + frozenRowsHeight, grid[_].canvas.width - frozenColsWidth, grid[_].canvas.height - frozenRowsHeight);
}
/** @private */
...
class BaseMouseDownMover {
    ...
    constructor(grid) {
        this._grid = grid;
        this._handler = new _internal_EventHandler__WEBPACK_IMPORTED_MODULE_5__.EventHandler();
        this._events = {};
        this._started = false;
        this._moved = false;
    }
...
class ColumnResizer extends BaseMouseDownMover {
    ...
    _moveInternal(e) {
        ...
        this._grid.fireListeners(_DG_EVENT_TYPE__WEBPACK_IMPORTED_MODULE_4__.DG_EVENT_TYPE.RESIZE_COLUMN, {
            col: this._targetCol
        });
        return true;
    }
 ...
 * @private
 */
class FocusControl extends _EventTarget__WEBPACK_IMPORTED_MODULE_6__.EventTarget {
    _grid;
    _scrollable;
    _handler;
    _input;
    ...
    constructor(grid, parentElement, scrollable) {
        ...
        const handler = (this._handler = new _internal_EventHandler__WEBPACK_IMPORTED_MODULE_5__.EventHandler());
        ...
        if (_internal_utils__WEBPACK_IMPORTED_MODULE_3__.browser.IE) {
        ...
        if (_internal_utils__WEBPACK_IMPORTED_MODULE_3__.browser.Edge) {
            handler.once(document, 'keydown', (e) => {
                if (!(0,_internal_utils__WEBPACK_IMPORTED_MODULE_3__.isDescendantElement)(parentElement, e.target)) {
                    return;
                }
        ...
        handler.on(document, 'copy', (e) => {
            ...
            setSafeInputValue(input, '');
            const data = _internal_utils__WEBPACK_IMPORTED_MODULE_3__.array.find(this.fireListeners('copy'), (r) => r != null);
            if (data != null) {
                cancelEvent(e);
                if (_internal_utils__WEBPACK_IMPORTED_MODULE_3__.browser.IE) {
                    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    setFocusRect(rect) {
        ...
        input.style.top = `${(top - _internal_style__WEBPACK_IMPORTED_MODULE_2__.getScrollBarSize()).toFixed()}px`; //position:relative だとずれるが、IEは position:relativeじゃないと最大値まで利用できない
        input.style.left = `${rect.left.toFixed()}px`;
        input.style.width = `${rect.width.toFixed()}px`;
        input.style.height = `${rect.height.toFixed()}px`;
    }
 ...
 */
class Selection extends _EventTarget__WEBPACK_IMPORTED_MODULE_6__.EventTarget {
    _grid;
    _sel;
    _focus;
    _start;
    ...
    _wrapFireSelectedEvent(callback) {
        if (this._isWraped) {
            ...
            try {
                ...
                this.fireListeners(_DG_EVENT_TYPE__WEBPACK_IMPORTED_MODULE_4__.DG_EVENT_TYPE.SELECTED_CELL, before);
                this.fireListeners(_DG_EVENT_TYPE__WEBPACK_IMPORTED_MODULE_4__.DG_EVENT_TYPE.SELECTED_CELL, after);
            }
            finally {
...
class DrawCellContext {
    ...
    _toRelativeDrawRect(absoluteRect) {
        ...
        if (grid.frozenColCount >= 0 && (!isFrozenCell || !isFrozenCell.col)) {
            ...
            rect = _internal_Rect__WEBPACK_IMPORTED_MODULE_8__.Rect.bounds(Math.max(rect.left, fRect.right), rect.top, rect.right, rect.bottom);
        }
        if (grid.frozenRowCount >= 0 && (!isFrozenCell || !isFrozenCell.row)) {
            const fRect = grid.getCellRect(this._col, grid.frozenRowCount - 1);
            rect = _internal_Rect__WEBPACK_IMPORTED_MODULE_8__.Rect.bounds(rect.left, Math.max(rect.top, fRect.bottom), rect.right, rect.bottom);
        }
        if (!rect.intersection(visibleRect)) {
            return null;
        }
 ...
 * @memberof cheetahGrid.core
 */
class DrawGrid extends _EventTarget__WEBPACK_IMPORTED_MODULE_6__.EventTarget {
    [protectedKey];
    static get EVENT_TYPE() {
        return _DG_EVENT_TYPE__WEBPACK_IMPORTED_MODULE_4__.DG_EVENT_TYPE;
    }
    constructor(options = {}) {
        super();
        ...
        const protectedSpace = (this[_] = {});
        _internal_style__WEBPACK_IMPORTED_MODULE_2__.initDocument();
        protectedSpace.element = createRootElement();
        protectedSpace.scrollable = new _internal_Scrollable__WEBPACK_IMPORTED_MODULE_9__.Scrollable();
        protectedSpace.handler = new _internal_EventHandler__WEBPACK_IMPORTED_MODULE_5__.EventHandler();
        ...
        protectedSpace.canvas = _internal_hiDPI__WEBPACK_IMPORTED_MODULE_1__.transform(document.createElement('canvas'));
        ...
        /////
        protectedSpace.rowHeightsMap = new _internal_NumberMap__WEBPACK_IMPORTED_MODULE_7__.NumberMap();
        protectedSpace.colWidthsMap = new _internal_NumberMap__WEBPACK_IMPORTED_MODULE_7__.NumberMap();
        ...
        protectedSpace.calcWidthContext = {
            ...
            get em() {
                return (0,_internal_canvases__WEBPACK_IMPORTED_MODULE_10__.getFontSize)(this._.context, this._.font).width;
            }
        };
    ...
    updateSize() {
        ...
        canvas.style.width = '';
        canvas.style.height = '';
        const width = Math.floor(canvas.offsetWidth || canvas.parentElement.offsetWidth - _internal_style__WEBPACK_IMPORTED_MODULE_2__.getScrollBarSize() /*for legacy*/);
        const height = Math.floor(canvas.offsetHeight || canvas.parentElement.offsetHeight - _internal_style__WEBPACK_IMPORTED_MODULE_2__.getScrollBarSize() /*for legacy*/);
        canvas.width = width;
    ...
    getCellRect(col, row) {
        ...
        return new _internal_Rect__WEBPACK_IMPORTED_MODULE_8__.Rect(absoluteLeft, absoluteTop, width, height);
    }
    /**
...
//private symbol
/** @private */
const _ = (0,_internal_symbolManager__WEBPACK_IMPORTED_MODULE_1__.get)();
/** @private */
let nextId = 1;
/**
 * event target.
...
const Symbol = _utils__WEBPACK_IMPORTED_MODULE_0__.isNode
    ? __webpack_require__.g.Symbol
    : window.Symbol
        ? window.Symbol
        : (() => {
            function random() {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (kakaGrid);
//
//
// export {
//     core,
