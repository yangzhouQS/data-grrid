import type {
    ColumnIconOption, FontIcon, ImageIcon, NamedIcon, PathIcon, SvgIcon
} from '../ts-types'
...
type IconPropKey = (keyof FontIcon<unknown> |
    keyof ImageIcon<unknown> |
    keyof PathIcon<unknown> |
    keyof SvgIcon<unknown> |
    keyof NamedIcon<unknown>) & keyof SimpleColumnIconOption;
...
const doms: { [tagName: string]: HTMLElement; } = {}
...
function toSimpleArray(
    ...
    SimpleColumnIconOption[] | ColumnIconOption<unknown> | ColumnIconOption<unknown>[] {
    if (!iconProps) {
        return iconProps
...
function normarize(iconProps: SimpleColumnIconOption): SimpleColumnIconOption {
    const data: SimpleColumnIconOption | any = {}
